...
@WebFilter(filterName="FiltroAutorizacioIndependiente")
public class FiltroAutorizacionIndependiente implements Filter {
	...
	public FiltroAutorizacionIndependiente() {
	}
